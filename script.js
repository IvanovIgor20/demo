var teams = 
    ...
    function color(object) {
        ...
        tr.innerHTML =
          '<td class="' + type[object.color] + '">' + object.place + '</td>' +       
          '<td class="left"><img src="http://icons.iconarchive.com/icons/custom-icon-design/all-country-flag/16/Italy-Flag-icon.png" align="left"><a href =\"'+ object.tag_url +'\">' + object.name + '</a></td>' +
          '<td class="teamMatches">' + object.matches + '</td>' +
          '<td class="teamWin">' + object.win + '</td>' +
          '<td class="teamDraw">' + object.draw + '</td>'+
          '<td class="teamLose">' + object.lose + '</td>'+
          '<td class="teamgoals">' + object.goals + '</td>'+
          '<td class="team_m_goals">' + object.conceded_goals + '</td>'+
          '<td>' + object.score + '</td>';
